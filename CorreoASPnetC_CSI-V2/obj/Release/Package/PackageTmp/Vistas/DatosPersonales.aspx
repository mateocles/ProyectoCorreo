...
<asp:Button ID="GuardarPersona" runat="server" Text="Guardar Perso" class="btn btn-primary"></asp:Button>
<asp:Button ID="BuscarPersona" runat="server" Text="Buscar Perso" class="btn btn-primary"></asp:Button>
<asp:Button ID="ModificarPersona" runat="server" Text="Modificar Perso" class="btn btn-primary"></asp:Button>
       

    </form>
    <br>
<asp:Button ID="Button1" runat="server" Text="Enviar Mensaje"></asp:Button>
<asp:Button ID="Button2" runat="server" Text="Volver"></asp:Button>
