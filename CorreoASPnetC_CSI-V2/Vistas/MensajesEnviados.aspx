<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MensajesEnviados.aspx.cs" Inherits="CorreoASPnetC_CSI_V2.Vistas.MensajesEnviados" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Enviados</title>
        ...
        <body background= "/Css/2.jpg">
            <h1 class="bg-primary">Enviados</h1>
  ...
  <table border="0" width="10" class="table" style="width:80%" cellspacing="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>MENSAJE</th>
                            <td><asp:GridView ID="GridView1" class="table table-striped" runat="server"  readonly="readonly" rows="5" cols="60"  style="margin: 0px; " Height="152px" Width="518px"></asp:GridView>
